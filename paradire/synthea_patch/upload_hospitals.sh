...
find "$curr_dir/$output_dir/$pt/fhir/" -type f -name "hospitalInformation*.json" | parallel 'file={}; echo "$file"; curl http://localhost:8080/fhir --data-binary "@$file" -H "Content-Type: application/fhir+json"; echo'
