...
./run_synthea -p 115200 Alberta
./run_synthea -p 135200 "British Columbia"
./run_synthea -p 36300 Manitoba
./run_synthea -p 20900 "New Brunswick"
./run_synthea -p 13800 "Newfoundland and Labrador"
./run_synthea -p 1100 "Northwest Territories"
./run_synthea -p 26200 "Nova Scotia"
./run_synthea -p 1000 Nunavut
./run_synthea -p 384500 Ontario
./run_synthea -p 4200 "Prince Edward Island"
./run_synthea -p 229800 Quebec
./run_synthea -p 30600 Saskatchewan
./run_synthea -p 1100 Yukon