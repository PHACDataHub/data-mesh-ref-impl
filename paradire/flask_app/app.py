...
entities = {
    ...
    "Alberta (AB)": [
        ...
        {"name": "HAPI FHIR Server", "url": "https://fhir.ab.paradire.phac-aspc.alpha.canada.ca"},
    ...
    "British Columbia (BC)": [
        ...
        {"name": "HAPI FHIR Server", "url": "https://fhir.bc.paradire.phac-aspc.alpha.canada.ca"},
    ...
    "Manitoba (MB)": [
        ...
        {"name": "HAPI FHIR Server", "url": "https://fhir.mb.paradire.phac-aspc.alpha.canada.ca"},
    ...
    "New Brunswick (NB)": [
        ...
        {"name": "HAPI FHIR Server", "url": "https://fhir.nb.paradire.phac-aspc.alpha.canada.ca"},
    ...
    "Newfoundland and Labrador (NL)": [
        ...
        {"name": "HAPI FHIR Server", "url": "https://fhir.nl.paradire.phac-aspc.alpha.canada.ca"},
    ...
    "Nova Scotia (NS)": [
        ...
        {"name": "HAPI FHIR Server", "url": "https://fhir.ns.paradire.phac-aspc.alpha.canada.ca"},
    ...
    "Nunavut (NU)": [
        ...
        {"name": "HAPI FHIR Server", "url": "https://fhir.nu.paradire.phac-aspc.alpha.canada.ca"},
    ...
    "Northwest Territories (NT)": [
        ...
        {"name": "HAPI FHIR Server", "url": "https://fhir.nt.paradire.phac-aspc.alpha.canada.ca"},
    ...
    "Ontario (ON)": [
        ...
        {"name": "HAPI FHIR Server", "url": "https://fhir.on.paradire.phac-aspc.alpha.canada.ca"},
    ...
    "Prince Edward Island (PE)": [
        ...
        {"name": "HAPI FHIR Server", "url": "https://fhir.pe.paradire.phac-aspc.alpha.canada.ca"},
    ...
    "Quebec (QC)": [
        ...
        {"name": "HAPI FHIR Server", "url": "https://fhir.qc.paradire.phac-aspc.alpha.canada.ca"},
    ...
    "Saskatchewan (SK)": [
        ...
        {"name": "HAPI FHIR Server", "url": "https://fhir.sk.paradire.phac-aspc.alpha.canada.ca"},
    ...
    "Yukon (YT)": [
        ...
        {"name": "HAPI FHIR Server", "url": "https://fhir.yt.paradire.phac-aspc.alpha.canada.ca"},
