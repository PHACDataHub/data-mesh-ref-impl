...
./scripts/kafka/get_topic_info.sh ${topic}
...
./scripts/kafka/get_consumer_group_info.sh ${consumer_group}

./scripts/kafka/reset_consumer_all_offsets.sh ${consumer_group}
