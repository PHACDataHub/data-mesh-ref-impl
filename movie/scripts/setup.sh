...
# Using connector not present in Confluent Hub
# Note that mount points for the downloaded connector must be available for all (distributed) Kafka connect instances
